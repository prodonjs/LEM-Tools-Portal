    ...
    <table class="table">
        <thead>
            <tr>
                ...
                <th><?php echo $this->Paginator->sort('LemUser.email', 'User'); ?></th>
        ...
        <tbody>
            ...
            <tr>
                <td>
                    <?php
                    echo $this->Html->link('Manage', array('action' => 'edit', $o['Order']['id']), array(
                        'class' => 'btn btn-mini'
                    ));
                    ?>
                </td>
                <td><?php printf('%06d',$o['Order']['id']); ?></td>
                <td><?php echo h($o['LemUser']['email']); ?></td>
                <td><?php echo h($o['Customer']['name']); ?></td>
                <td>
                    <?php
