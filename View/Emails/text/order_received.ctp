...
echo "Your order #: {$order['Order']['id']} has been accepted and has been put into processing. ";
echo "You will be notified when your order has been invoiced and informed of any shipping information. ";
