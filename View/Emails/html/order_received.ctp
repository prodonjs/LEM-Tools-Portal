<p>
    ...
    Web order #: <?php printf('%06d', $order['Order']['id']); ?> has been accepted and has been put into processing.
    You will be notified when your order has been invoiced and informed of any shipping information.
